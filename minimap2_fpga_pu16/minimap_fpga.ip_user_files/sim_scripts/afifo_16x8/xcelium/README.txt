...
#
# Generated by export_simulation on Fri Dec 06 15:03:27 CST 2019
#
################################################################################
...
'-reset_run' switch to the './afifo_16x8.sh' script.

./afifo_16x8.sh -reset_run
...
./afifo_16x8.sh -noclean_files

For more information on the script, please type './afifo_16x8.sh -help'.
