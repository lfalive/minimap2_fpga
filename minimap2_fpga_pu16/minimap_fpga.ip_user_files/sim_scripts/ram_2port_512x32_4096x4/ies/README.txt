...
#
# Generated by export_simulation on Mon Jul 22 20:28:40 CST 2019
#
################################################################################
...
'-reset_run' switch to the './ram_2port_512x32_4096x4.sh' script.

./ram_2port_512x32_4096x4.sh -reset_run
...
./ram_2port_512x32_4096x4.sh -noclean_files

For more information on the script, please type './ram_2port_512x32_4096x4.sh -help'.
