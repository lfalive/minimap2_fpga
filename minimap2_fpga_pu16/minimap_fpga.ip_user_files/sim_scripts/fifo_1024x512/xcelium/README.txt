...
#
# Generated by export_simulation on Sat Sep 07 16:27:23 CST 2019
#
################################################################################
...
'-reset_run' switch to the './fifo_1024x512.sh' script.

./fifo_1024x512.sh -reset_run
...
./fifo_1024x512.sh -noclean_files

For more information on the script, please type './fifo_1024x512.sh -help'.
