...
#
# Generated by export_simulation on Tue Jan 05 09:17:20 CST 2021
#
################################################################################
...
'-reset_run' switch to the './ram_512x8192.sh' script.

./ram_512x8192.sh -reset_run
...
./ram_512x8192.sh -noclean_files

For more information on the script, please type './ram_512x8192.sh -help'.
