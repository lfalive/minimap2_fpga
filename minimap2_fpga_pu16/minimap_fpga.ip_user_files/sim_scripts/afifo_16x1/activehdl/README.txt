...
#
# Generated by export_simulation on Sat Sep 07 16:23:54 CST 2019
#
################################################################################
...
'-reset_run' switch to the './afifo_16x1.sh' script.

./afifo_16x1.sh -reset_run
...
./afifo_16x1.sh -noclean_files

For more information on the script, please type './afifo_16x1.sh -help'.
